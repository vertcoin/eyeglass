...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "EyeGlass " + FormatFullVersion();
...
static const char *strMainNetDNSSeed[][2] = {
    {"pool.verters.com", "178.33.14.208"},
    {"5.196.78.159","5.196.78.159"},
    {NULL, NULL}
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. EyeGlass is probably already running."), addrBind.ToString().c_str());
        else
